...
university-logo: templates/UNAM_logo.png
...
linkcolor-rgb: "0,0,139"  # coloring normal links looks a bit excessive, as it highlights also all links in the table of contents
...
source('scripts_andgit_filters/create_chunk_options.R')
