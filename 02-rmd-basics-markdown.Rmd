...
```{r cell-dimensions-relationship, fig.align='center', echo=FALSE, fig.cap="Do something coooooool", out.width='75%', fig.pos='H'}
...
```{r filamentation-model-ramp-signal, fig.pos='H', out.width="100%", echo=FALSE, results='asis', fig.cap=filamentation_model_ramp_signal_cap}
