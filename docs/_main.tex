...
{\centering \includegraphics[width=0.75\linewidth]{downloadFigs4latex__main/cell-dimensions-relationship} 

}

\caption{Do something coooooool}\label{fig:cell-dimensions-relationship}
\end{figure}
