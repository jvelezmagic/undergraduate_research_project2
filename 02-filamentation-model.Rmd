...
```{r filamentation-model-ramp-signal3, fig.pos='H', out.width="100%", echo=FALSE, fig.cap=filamentation_model_ramp_signal_cap, fig.scap="Effect of filamentation on intracellular toxin concentration."}
knitr::include_graphics("figures/filamentation_model_ramp_signal.png")
```
