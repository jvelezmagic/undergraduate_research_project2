...
```{r filamentation-model-ramp-signal, fig.pos='H', out.width="100%",out.height='1000px', echo=FALSE, results='asis', fig.cap=filamentation_model_ramp_signal_cap, fig.scap="Effect of filamentation on intracellular toxin concentration."}
